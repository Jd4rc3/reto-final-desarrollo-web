 ...
 * ColumnRepository is an interface which inherits from the JPA repository and allows access to the methods to be consumed by the service to perform the business logic.
 */
public interface ColumnRepository extends JpaRepository<ColumnDomain, Integer> {
     ...
     * @LuisaAvila @DanielArce
     * @Query query in column and columForBoard where the board identifier is equal to the identifier passed as parameter
     */
