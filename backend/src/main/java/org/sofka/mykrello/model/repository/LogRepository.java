 ...
 * LogRepository is an interface which inherits from the JPA repository and allows access to the methods to be consumed by the service to perform the business logic.
 */
public interface LogRepository extends JpaRepository<LogDomain, Integer> {

    /**
     * @LuisaAvila @DanielArce
     * getCurrentColumn a query is made to obtain the current value of the column where the task is located
    ...
    /**
     * @LuisaAvila @DanielArce
     * setNewColumns allows inserting into the database the values of the column where the task was located and the value of the current column.
